...
export default function Home() {
  return (
    <main className="w-full">
      <section className="bg-[linear-gradient(to_bottom,transparent,theme(colors.slate.950)),url('/IMAGEM_DO_SITE.png')] bg-contain bg-center bg-no-repeat w-full h-screen flex items-center">
